...
#define KNIGHT_LIMB_MAX OBJECT_KNIGHT_1_LIMB_MAX
#define IGOS_LIMB_MAX OBJECT_KNIGHT_1_LIMB_MAX

static_assert((u32)IGOS_LIMB_MAX == (u32)OBJECT_KNIGHT_1_LIMB_MAX,
...
typedef struct EnKnight {
    ...
    /* 0x2C4 */ Vec3s jointTable[OBJECT_KNIGHT_1_LIMB_MAX];
    /* 0x372 */ Vec3s morphTable[OBJECT_KNIGHT_1_LIMB_MAX];
